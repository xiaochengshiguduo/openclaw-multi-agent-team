...
const TASK_TEMPLATE_FILES = ['metadata.md', 'routing.md', 'status.md', 'brief.md', 'plan.md'];
const ALL_TASK_TEMPLATE_FILES = [
  'metadata.md', 'routing.md', 'status.md', 'brief.md', 'plan.md', 'agent-output.md', 'requirements-package.md',
