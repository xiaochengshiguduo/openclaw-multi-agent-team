...
> 依据：`docs/getting-started/reproduce-on-new-machine.md` 新机器复现指南  
...
- 更新 `docs/getting-started/reproduce-on-new-machine.md`：
...
- 新增 `examples/e2e-drill/prompts.md`。
...
- 建立 `docs/reference/compatibility.md` 的版本矩阵：
  - OpenClaw version
...
- `docs/getting-started/reproduce-on-new-machine.md` 补充 restart 和 warning 说明
- `docs/guides/run-an-e2e-drill.md` 增加完整人工 prompt 包
- `examples/e2e-drill/prompts.md`
...
- `docs/reference/compatibility.md`：补充 2026.5.28 结果
